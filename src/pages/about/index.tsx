...
const AboutPage: NextPage = () => (
  <>
    ...
    >
      <Text>
        CherrySwap is a fast growing service that offers users fast and profitable exchanges. The success of the work is
        based on the prompt work of specialists, a user-friendly interface, and mutually beneficial courses. Every
